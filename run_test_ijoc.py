...
Gs = [
    ...
    'r-75-0.4-9-142', 'r-75-0.4-10-143',
    'r-75-0.5-1-144',
    'r-75-0.5-2-145',
    'r-75-0.5-3-146',
    'r-75-0.5-4-147',
...
# Gx TEST
DIRTEST = 'C:\\Users\\Gualandi\\Desktop\\data-rnd.ijoc\\'
COMMANDS = []

for dt in Gs:
    TEST = join(DIRTEST, dt)

    LOG = join('./tmp/' + dt + '.bib.3.log')
    CMD = 'RankSepBiB ' + TEST + ' 3 > ' + LOG
    COMMANDS.append(CMD)

# for dt in Gs:
#     TEST = join(DIRTEST, dt)

#     LOG = join('./tmp/'+dt+'.mip.log')
#     CMD = 'RankSepMip '+TEST+' 3 > ' + LOG
#     COMMANDS.append(CMD)
